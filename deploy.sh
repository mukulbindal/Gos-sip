...
#     openssl req -new -key server.key -out server.csr -subj "/C=IN/ST=UP/L=Kanpur/O=SeaGreen/OU=Owlbox/CN=ec2-54-146-78-115.compute-1.amazonaws.com/emailAddress=the.owl.box.project@outlook.com/";
